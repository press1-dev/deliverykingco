  ...
  return (
    <div className="group relative flex flex-col gap-y-5 rounded-[4px] border border-white/5 bg-[#1B1B1E] p-3 transition-all duration-500 hover:border-[#CCFF00]/20 hover:shadow-[0_20px_40px_rgba(0,0,0,0.4)]">
      ...
      <div className="flex items-end justify-between px-1 pb-1">
        ...
        <button
          className="flex h-10 w-10 shrink-0 items-center justify-center rounded-full bg-[#2A2A2D] text-white/60 transition-all duration-300 hover:scale-110 hover:bg-[#CCFF00] hover:text-black hover:shadow-[0_0_20px_rgba(204,255,0,0.4)] active:scale-95"
          title="Add to Cart"
        >
