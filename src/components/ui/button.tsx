  ...
  return (
    <button
      ...
      className={clsx(
        ...
        {
          primary:
            "border-[var(--button-primary-border,hsl(var(--primary)))] bg-primary text-[var(--button-primary-text,hsl(var(--foreground)))] after:bg-[var(--button-primary-background-hover,color-mix(in_oklab,hsl(var(--primary)),white_75%))]",
          secondary:
